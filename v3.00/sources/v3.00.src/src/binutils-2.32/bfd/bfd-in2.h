...
#define SEC_INFO_TYPE_EH_FRAME_ENTRY 6
  ...
  /* dsPIC-specific bits */
  /* Note: When you need to change or add a section flag,
     edit the strange-looking lines found in bfd/section.c.
     Don't forget the macro BFD_FAKE_SECTION defined there also.

     Note that 'slash-dot' is represented as 'curly-dot', and lines
     to be propagated are preceded by a '.'

     After updating file section.c, excecute 'make headers' in
     <build_dir>/bfd which then propagates the asection
     definition to other files such as bfd-in2.h.

     You must also make matching changes in pic30-utils.h,
     pic30-attributes.h, objcopy.c, and objdump.c.  GM 7/21 */
  unsigned int near:1;
  unsigned int persistent:1;
  unsigned int xmemory:1;
  unsigned int ymemory:1;
  unsigned int psv:1;
  ...
  /* The total size of alignment gaps in the section, in octets.  */
  unsigned int alignment_gaps;
...
struct pic30_section_info {
   ...
   PTR last_sym;
   unsigned long last_sym_location;
};

#define TC_SEGMENT_INFO_TYPE struct pic30_section_info
...
{
  ptr->vma = ptr->lma = val;
  /* ptr->user_set_vma = TRUE; PIC30 controls this flag separately */
  return TRUE;
}
...
#define BFD_FAKE_SECTION(SEC, SYM, NAME, IDX, FLAGS)                   \
  ...
  /* segment_mark, sec_info_type, use_rela_p,                      */  \
     0,            0,             1,                                   \
                                                                       \
  /* need_finalize_relax, near, persistent, xmemory, ymemory, psv,   */        \
     0,                   0,    0,          0,       0,       0,               \
                                                                       \
  /* eedata, absolute, reverse, unordered, dma, boot,   */     \
     0,      0,        0,       0,         0,   0,             \
                                                                       \
  /* secure, memory, heap, eds, page, stack,   */      \
     0,      0,      0,    0,   0,    0,               \
                                                                       \
  /* auxflash, packedflash, linked, shared, keep, preserved,   */      \
     0,        0,           0,      0,      0,    0,           \
                                                                       \
  /* auxpsv, linker_generated, update, priority,     */        \
     0,      0,                0,      0,              \
                                                                       \
  ...
  /* symbol,                    symbol_ptr_ptr,                    */  \
     (struct bfd_symbol *) SYM, &SEC.symbol,                           \
                                                                       \
  /* map_head, map_tail, alignment_gaps                            */  \
     { NULL }, { NULL }, 0                                             \
    }
...
#define bfd_mach_cris_v10_v32  1032
  bfd_arch_pic30,     /* Microchip PIC30 */
#define bfd_mach_P30F2010 1
#define bfd_mach_P30F3010 2
#define bfd_mach_P30F4012 3
#define bfd_mach_P30F3011 4
#define bfd_mach_P30F4011 5
#define bfd_mach_P30F5015 6
#define bfd_mach_P30F5010 7
#define bfd_mach_P30F6010 8
#define bfd_mach_P30F2011 9
#define bfd_mach_P30F3012 10
#define bfd_mach_P30F2012 11
#define bfd_mach_P30F3013 12
#define bfd_mach_P30F3014 13
#define bfd_mach_P30F4013 14
#define bfd_mach_P30F4014 15
#define bfd_mach_P30F5011 16
#define bfd_mach_P30F5012 17
#define bfd_mach_P30F6011 18
#define bfd_mach_P30F6012 19
#define bfd_mach_P30F4015 20
#define bfd_mach_P30F5013 21
#define bfd_mach_P30F5014 22
#define bfd_mach_P30F6013 23
#define bfd_mach_P30F6014 24
#define bfd_mach_P30F5016 25
#define bfd_mach_P30F6015 26
#define bfd_mach_P30F6010A 27
#define bfd_mach_P30F6011A 28
#define bfd_mach_P30F6012A 29
#define bfd_mach_P30F6013A 30
#define bfd_mach_P30F6014A 31
#define bfd_mach_P30F2020 35
#define bfd_mach_P30F2021 36
#define bfd_mach_P30F2022 37
#define bfd_mach_P30F2023 38
#define bfd_mach_P30F2005 39
#define bfd_mach_P30F2010A 40

#define bfd_mach_GENERIC_16BIT 90
#define bfd_mach_GENERIC_16DSP 91

#define bfd_mach_P24FJ64GA006 100
#define bfd_mach_P24FJ64GA008 101
#define bfd_mach_P24FJ64GA010 102
#define bfd_mach_P24FJ96GA006 103
#define bfd_mach_P24FJ96GA008 104
#define bfd_mach_P24FJ96GA010 105
#define bfd_mach_P24FJ128GA006 106
#define bfd_mach_P24FJ128GA008 107
#define bfd_mach_P24FJ128GA010 108

#define bfd_mach_P24HJ64GP206 150
#define bfd_mach_P24HJ64GP210 151
#define bfd_mach_P24HJ256GP206 152
#define bfd_mach_P24HJ256GP610 153
#define bfd_mach_P24HJ64GP506 154
#define bfd_mach_P24HJ64GP510 155
#define bfd_mach_P24HJ128GP206 156
#define bfd_mach_P24HJ128GP306 157
#define bfd_mach_P24HJ128GP310 158
#define bfd_mach_P24HJ128GP506 159
#define bfd_mach_P24HJ128GP510 160
#define bfd_mach_P24HJ256GP210 161

#define bfd_mach_P33FJ64GP306 200
#define bfd_mach_P33FJ64GP308 201
#define bfd_mach_P33FJ64GP310 202
#define bfd_mach_P33FJ64GP506 203
#define bfd_mach_P33FJ64GP508 204
#define bfd_mach_P33FJ64GP510 205
#define bfd_mach_P33FJ128GP306 206
#define bfd_mach_P33FJ128GP308 207
#define bfd_mach_P33FJ128GP310 208
#define bfd_mach_P33FJ128GP506 209
#define bfd_mach_P33FJ128GP508 210
#define bfd_mach_P33FJ128GP510 211
#define bfd_mach_P33FJ256GP506 212
#define bfd_mach_P33FJ256GP508 213
#define bfd_mach_P33FJ256GP510 214
#define bfd_mach_P33FJ64MC306 215
#define bfd_mach_P33FJ64MC308 216
#define bfd_mach_P33FJ64MC310 217
#define bfd_mach_P33FJ64MC506 218
#define bfd_mach_P33FJ64MC508 219
#define bfd_mach_P33FJ64MC510 220
#define bfd_mach_P33FJ128MC306 221
#define bfd_mach_P33FJ128MC308 222
#define bfd_mach_P33FJ128MC310 223
#define bfd_mach_P33FJ128MC506 224
#define bfd_mach_P33FJ128MC508 225
#define bfd_mach_P33FJ128MC510 226
#define bfd_mach_P33FJ256MC506 227
#define bfd_mach_P33FJ256MC508 228
#define bfd_mach_P33FJ256MC510 229

#define bfd_mach_P33FJ64GP206 230
#define bfd_mach_P33FJ64GP706 231
#define bfd_mach_P33FJ64GP708 232
#define bfd_mach_P33FJ64GP710 233
#define bfd_mach_P33FJ128GP706 234
#define bfd_mach_P33FJ128GP708 235
#define bfd_mach_P33FJ128GP710 236
#define bfd_mach_P33FJ256GP710 237

#define bfd_mach_P33FJ64MC706 238
#define bfd_mach_P33FJ64MC710 239
#define bfd_mach_P33FJ128MC706 240
#define bfd_mach_P33FJ128MC708 241
#define bfd_mach_P33FJ128MC710 242
#define bfd_mach_P33FJ256MC710 243

#define bfd_mach_last 99999999
  bfd_arch_riscv,
...
/* PIC30 specific relocations  */
  ...
  BFD_RELOC_PIC30_UNSIGNED_2,
  BFD_RELOC_PIC30_WID5,
  BFD_RELOC_PIC30_SHIFT8_UNSIGNED_8,
  BFD_RELOC_PIC30_ADDR_LO,
  BFD_RELOC_PIC30_ADDR_HI,
  BFD_RELOC_PIC30_WORD_ADDR_LO,
  BFD_RELOC_PIC30_WORD_ADDR_HI,
  BFD_RELOC_PIC30_UNIFIED_LO,
  BFD_RELOC_PIC30_UNIFIED_HI,
  BFD_RELOC_PIC30_WORD_UNIFIED_LO,
  BFD_RELOC_PIC30_WORD_UNIFIED_HI,
  BFD_RELOC_PIC30_P_ADDR_LO,
  BFD_RELOC_PIC30_P_ADDR_HI,
  BFD_RELOC_PIC30_BRANCH_ABSOLUTE6,
  BFD_RELOC_PIC30_WORD24,
  BFD_RELOC_PIC30_PGM_ADDR24,
  BFD_RELOC_PIC30_FILE_REG_BYTE16,
  BFD_RELOC_PIC30_FILE_REG_W16,
  BFD_RELOC_PIC30_FILE_REG_L16,
  BFD_RELOC_PIC30_PCREL_BRANCH24,
  BFD_RELOC_PIC30_BRANCH_ABSOLUTE24,
  BFD_RELOC_PIC30_FILE_REG_W20,
  BFD_RELOC_PIC30_FILE_REG_L20,
  BFD_RELOC_PIC30_FILE_REG_BYTE20,
  BFD_RELOC_PIC30_PCREL_FBRANCH24,
  BFD_RELOC_PIC30_WORD32,
  BFD_RELOC_PIC30_PCREL16_32_BRANCH,
  BFD_RELOC_PIC30_FRAME_SIZE_7_32,
  BFD_RELOC_PIC30_U16_32,
  BFD_RELOC_PIC30_MOVS_8_32,
  BFD_RELOC_PIC30_MOVS_16_32,
  BFD_RELOC_PIC30_WORD24_8,
  BFD_RELOC_PIC30_WORD24_16,
  BFD_RELOC_PIC30_ERROR,
  BFD_RELOC_PIC30_NO_ERROR,
