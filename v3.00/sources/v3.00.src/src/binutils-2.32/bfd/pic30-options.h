...
static int process_token (char *, char*, cg_option_type *);
static void parse_option_list (char *, cg_option_type *, char *);
static int  pic30_parse_args (int, char **); 
static void pic30_list_options (FILE *); 
static void pic30_process_fill_argument (char *fill_arg);
