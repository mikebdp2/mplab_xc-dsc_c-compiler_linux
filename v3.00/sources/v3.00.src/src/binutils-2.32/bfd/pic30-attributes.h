...
/*
 * MASK5: Reserved section names with implied attributes
 *  - for dsPIC33A devices
 *
 *  MASK5( name, quiet, type, modifier)
 *
 *  name:     reserved section name
 *  quiet:    set implied attribute(s) quietly?
 *            (0 = no, 1 = yes)
...
MASK5( .bss,     1, bss, 0 )
MASK5( .xbss,    0, bss, 0 )
MASK5( .xdata,   0, data, 0 )
MASK5( .nbss,    0, bss, near )
MASK5( .ndata,   0, data, near )
MASK5( .ndconst, 0, data, near )
MASK5( .pbss,    0, persist, 0 )
MASK5( .dconst,  0, data, 0 )
MASK5( .ybss,    0, bss, 0)
MASK5( .ydata,   0, data, 0)
MASK5( .const,   0, code, 0 )
MASK5( .eedata,  0, data, 0 )
