...
#include "as.h"
#include "subsegs.h"  /* this one includes tc-pic30.h */
...
#ifdef TC_PIC30
  fprintf (stderr, _("GNU assembler version "));
  fprintf (stderr, VERSION "(%s) using BFD version %s %s\n",
	   pic30_resource_version, TARGET_ALIAS, BFD_VERSION_STRING);
#else
  ...
  enum option_values
    {
      ...
      OPTION_PIC30_DFP,       /* = STD_BASE + 41 */
      OPTION_PIC30_NO_ISA16,  /* = STD_BASE + 42 */
...
#ifdef TC_PIC30
    ,{"no-isa16", no_argument, NULL, OPTION_PIC30_NO_ISA16}
#endif
...
#ifdef TC_PIC30
	  user_listing_lhs_width = listing_lhs_width;
#endif
	  break;
...
#ifdef TC_PIC30
	    user_listing_lhs_width_second = listing_lhs_width_second;
#endif
	  break;
	case OPTION_LISTING_RHS_WIDTH:
	  listing_rhs_width = atoi (optarg);
#ifdef TC_PIC30
	  if (listing_rhs_width < 1)
	    listing_rhs_width = 1;
#endif
	  break;
