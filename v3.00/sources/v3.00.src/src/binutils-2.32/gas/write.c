...
relax_addressT relax_align (relax_addressT addr, int align);
...
#ifdef TC_PIC30
/* Support alignment in all types of sections */
...
subsegs_finish_section (asection *s)
{
  ...
  for (frchainP = seginfo->frchainP;
	  ...
	  && now_seg->entsize)
	{
      ...
      */
      if ((alignment) && (!pic30_is_isav32_machine(global_PROCESSOR)))
        alignment += 1;
      /*
    ...
    /* Skip symbols which were equated to undefined or common
	  ...
	  if (symp == abs_section_sym
		 ...
		 latter examines the name...  */
	      ...
	      || (!S_IS_EXTERNAL (symp)
		  && (punt || S_IS_LOCAL (symp) ||
		  /* Note: The following condition does not exist in binutils v2.14 */
...
relax_segment (struct frag *segment_frag_root, segT segment, int pass)
{
  ...
  for (frag_count = 0, fragP = segment_frag_root;
    ...
    /* Note: the following line does not apear in binutils v2.14 */
	  region += 1;
	  break;
