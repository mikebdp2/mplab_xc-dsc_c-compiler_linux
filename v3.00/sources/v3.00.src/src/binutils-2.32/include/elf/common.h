...
#else
#define SHF_EXCLUDE   (1 << 16)         /* move this flag to bit 16 */
#define SHF_GNU_MBIND (1 << 17)         /* move this flag to bit 17 */
#endif
...
#if PIC30
/* This one was dropped between binutils-v2.14 and 2.32, but we need it */
