...
#define PIC30_IS_32_BIT_LITERAL(lit) (((lit) >= -2147483647) && ((lit) < 4294967295))
...
#define PIC30_IS_2_BIT_UNSIGNED_LITERAL(lit) (((lit) >= 0) && ((lit) <= 3 ))
#define PIC30_IS_WID5_LITERAL(lit) (((lit) >= 1) && ((lit) <= 16 ))
#define PIC30_IS_24_BIT_LITERAL(lit) (((lit) >= -8388608) && ((lit)<= 0xFFFFFF))
#define PIC30_IS_20_BIT_LITERAL(lit) (((lit) >= -524288) && ((lit) <= 0xFFFFF))
#define PIC30_IS_12_BIT_LITERAL(lit) ((lit & 0xFFFFF000UL) == 0)
#define PIC30_IS_6_BIT_UNSIGNED_LITERAL(lit) ((lit & 0xFFFFFFC0UL) == 0)
#define PIC30_IS_6_BIT_SIGNED_LITERAL(lit) (((lit) >= -32) && ((lit) <= 31))
#define PIC30_IS_7_BIT_SIGNED_LITERAL(lit) (((lit) >= -64) && ((lit) <= 63))
...
#define PIC30_PSVPTR(value) ((((value) & 0xFFFF8000) << 1) | \
        (((value) & 0x7FFF) << 1) | 0x1 )
#define PIC30_ADDR_LO(value)		((value) & 0xFFFF)
#define PIC30_ADDR_HI(value)		((value) >> 16)
...
#define PIC30_CAN_PRINT_IN_PROGRAM_MEMORY(addr,opb) \
  ((opb != 1) ? ((addr % 4) != 3) :  1)

#define PIC30_CAN_PRINT_IN_READONLY_MEMORY(addr,opb) \
  ((opb != 1) ? ((addr % 4) < 2) : 1)

#define PIC30_CAN_PRINT_IN_DATA_MEMORY(addr,opb) \
  ((opb != 1) ? ((addr % 2) != 1) : 1)
...
#define EF_PIC30_NO_PHANTOM_BYTE 0x80000000  /* set if encoding has no phantom
                                                byte */
...
START_RELOC_NUMBERS (elf_pic30_reloc_type)
  ...
  RELOC_NUMBER (R_PIC30_WORD_PACKED_HI,         83)
  RELOC_NUMBER (R_PIC30_WORD_PACKED_LO,         84)
  RELOC_NUMBER (R_PIC30_UNSIGNED_3,             85)
  RELOC_NUMBER (R_PIC30_UNSIGNED_2,             86)
  RELOC_NUMBER (R_PIC30_WID5,                   87)
  RELOC_NUMBER (R_PIC30_SHIFT8_UNSIGNED_8,      88)
  RELOC_NUMBER (R_PIC30_ADDR_LO,                89)
  RELOC_NUMBER (R_PIC30_ADDR_HI,                90)
  RELOC_NUMBER (R_PIC30_P_ADDR_LO,              91)
  RELOC_NUMBER (R_PIC30_P_ADDR_HI,              92)
  ...
  RELOC_NUMBER (R_PIC30_WORD24,                 100)
  RELOC_NUMBER (R_PIC30_PGM_ADDR24,             101)
  RELOC_NUMBER (R_PIC30_FILE_REG_BYTE16,        102)
  RELOC_NUMBER (R_PIC30_FILE_REG_W16,           103)
  RELOC_NUMBER (R_PIC30_FILE_REG_L16,           104)
  RELOC_NUMBER (R_PIC30_PCREL_BRANCH24,         105)
  RELOC_NUMBER (R_PIC30_BRANCH_ABSOLUTE24,      106)
  RELOC_NUMBER (R_PIC30_FILE_REG_W20,           107)
  RELOC_NUMBER (R_PIC30_FILE_REG_L20,           108)
  RELOC_NUMBER (R_PIC30_FILE_REG_BYTE20,        109)
  RELOC_NUMBER (R_PIC30_PCREL_FBRANCH24,        110)
  RELOC_NUMBER (R_PIC30_WORD32,                 111)
  RELOC_NUMBER (R_PIC30_PCREL16_32_BRANCH,      112)
  RELOC_NUMBER (R_PIC30_FRAME_SIZE_7_32,        113)
  RELOC_NUMBER (R_PIC30_PIC30_U16_32,           114)
  RELOC_NUMBER (R_PIC30_MOVS_8_32,              115)
  RELOC_NUMBER (R_PIC30_MOVS_16_32,             116)
  RELOC_NUMBER (R_PIC30_WORD24_8,               117)
  RELOC_NUMBER (R_PIC30_WORD24_16,              118)
  RELOC_NUMBER (R_PIC30_64,                     119)
...
struct location {
        ...
        int address;
        int end_address;};
struct pic30_fill_option
{
  struct pic30_fill_option *next;
  struct expression expr;
  struct location loc;
  struct pic30_section *fill_section_list;
  int fill_width;
  int range_size;
};
