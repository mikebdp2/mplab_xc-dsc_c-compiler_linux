...
#if PIC30
  /* disassembler and objdump both need this*/
  flagword flags_to_match;
#endif
...
extern void pic30_print_disassembler_options (FILE *);
extern void pic30_parse_disassembler_option  (char *);
