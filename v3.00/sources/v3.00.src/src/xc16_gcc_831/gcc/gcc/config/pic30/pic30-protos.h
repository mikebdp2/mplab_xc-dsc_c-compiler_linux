...
extern bool pic30_scalar_mode_supported_p(scalar_mode);
...
tree pic30_build_variant_type_copy(tree, int);
...
extern scalar_int_mode pic30_addr_space_pointer_mode(addr_space_t);
extern scalar_int_mode pic30_addr_space_address_mode(addr_space_t);
extern bool pic30_addr_space_valid_pointer_mode(scalar_int_mode ,addr_space_t);
...
extern int pic30_extended_ram_target(void);
...
extern void pic30_function_pre(FILE *, tree , const char *);
...
extern tree pic30_gimplify_va_arg_expr(tree, tree, gimple_seq *, gimple_seq *);
...
extern rtx pic30_legitimize_address(rtx, rtx, enum machine_mode mode);
...
extern int pic30_mem_umm_operand(rtx op, enum machine_mode mode);
extern int pic30_mem_wtumm_operand(rtx op, enum machine_mode mode);
...
extern void mchp_cache_conversion_state(const_rtx, const_rtx, tree);
extern int pic30_check_for_conversion(rtx_insn *);
...
extern HOST_WIDE_INT pic30_initial_elimination_offset(int, int);
...
extern void pic30_asm_output_ascii(FILE *, const char *, int);
extern void pic30_asm_file_end(void);
extern void pic30_asm_output_common(FILE *, char *, int, int);
extern void pic30_asm_output_aligned_common(FILE *, tree, const char *, int, int);
extern void pic30_asm_output_local(FILE *, char *, int, int);
extern void pic30_asm_output_aligned_decl_local(FILE *, tree, const char *, int, int);
extern void pic30_asm_output_aligned_local(FILE *, char *, int, int);
...
extern void pic30_asm_declare_function_name(FILE *, const char *, tree);
extern void pic30_asm_declare_object_name(FILE *, const char *, tree);
extern section *pic30_select_rtx_section (machine_mode mode ATTRIBUTE_UNUSED,
                            rtx x,
...
extern rtx
pic30_expand_builtin(tree, rtx, rtx, enum machine_mode, int);
#endif /* TREE_CODE and RTX_CODE*/
extern void pretty_tree_with_prototype(tree);

#ifdef RTX_CODE
extern int  pic30_dead_or_set_p(rtx_insn *, rtx);
extern int  pic30_dead_or_set_p_with_original(rtx_insn *, rtx, rtx);
extern void  pic30_final_prescan_insn(rtx_insn *, rtx*, int);
...
extern void  pic30_notice_update_cc(rtx, rtx_insn *);
extern int   pic30_check_legit_addr(enum machine_mode, rtx, int);
extern struct rtx_def * pic30_return_addr_rtx(int, rtx);
extern const char *pic30_movif_condition_code_name(enum rtx_code, 
                                                   enum machine_mode,
                                                   int *inverted);
extern char *pic30_conditional_move(rtx_insn *insn,rtx *operands);
extern char *pic30_conditional_move1(rtx_insn *insn,rtx *operands);
extern char *pic30_conditional_branch(enum rtx_code, rtx, int, int);
...
extern char *pic30_output_mov32si_rimm(long intval, int opno, int offset);

#define TARGET_SKIP_OPERATOR pic30_skip_operator
int pic30_skip_operator(rtx op, enum machine_mode);
int pic30_skip2_operator_helper(rtx op, enum machine_mode);
int pic30_skip1_operator_helper(rtx op, enum machine_mode);
...
int pic30_legitimize_reload_address(rtx, enum machine_mode,
                                    unsigned int,
                                    int,
                                    unsigned int,
                                    rtx_insn *);
...
extern int pic30_register_operand_helper(rtx op, enum machine_mode mode, 
                                         enum pic30_acceptible_regs_flags);
extern int pic30_mode1MinMax_APSV_operand(rtx op, enum machine_mode mode, const char *c);
...
extern bool pic30_valid_pointer_mode(scalar_int_mode);
...
bool pic30_do_not_force_space(tree);
rtx pic30_form_UMM_address(rtx);
rtx pic30_base_rtx(rtx);

char *pic30_skip(rtx_insn *, rtx *, int, int);

#ifdef GCC_C_PRAGMA_H
#endif

extern int pic30_num_regs;
extern int pic30_num_param_regs;
int pic30_is_valid_param_reg(int);

extern const char *pic30_print_opcode(FILE*,const char*);

extern int pic30_isa32_float_const(rtx);
extern int pic30_const_ok_for_str_p(HOST_WIDE_INT value, enum machine_mode mode,
                                    const char *constraint);

extern int pic30_mem_constraint (const char *str, rtx op);
extern tree pic30_lookup_attribute (const char*, tree);
extern tree pic30_maybe_get_identifier(const char *);
extern poly_int64 pic30_push_rounding (poly_int64 bytes);
extern bool pic30_attribute_takes_identifier_p (const_tree);
extern void pic30_register_target_pragmas (void);
bool pic30_assert(int val);

rtl_opt_pass *make_pass_validate_dsp_instructions (gcc::context *ctxt);
rtl_opt_pass *make_pass_merge_accumulators (gcc::context *ctxt);
rtl_opt_pass *make_pass_data_pic30_split_memrefs (gcc::context *ctxt);
rtl_opt_pass *make_pass_track_sfrs (gcc::context *ctxt);
rtl_opt_pass *make_pass_RAW_count (gcc::context *ctxt);
rtl_opt_pass *make_pass_PSV_PSV_count (gcc::context *ctxt);
rtl_opt_pass *make_pass_cse3 (gcc::context *ctxt);
rtl_opt_pass *make_pass_xc_coverage (gcc::context *ctxt);
rtl_opt_pass *make_pass_split_for_xc16 (gcc::context *ctxt);

extern int pic30_reg_referenced_p(const_rtx x,const_rtx body,int check_clobber);
extern rtx_insn *pic30_emit_insn_before_noloc(rtx pat, rtx_insn *insn,
                                              basic_block bb);
