...
const pass_data pass_data_cse3 =
{
  RTL_PASS, /* type */
  "cse3", /* name */
  OPTGROUP_NONE, /* optinfo_flags */
...
class pass_cse3 : public rtl_opt_pass
{
public:
  pass_cse3 (gcc::context *ctxt)
    : rtl_opt_pass (pass_data_cse3, ctxt)
  {}
...
rtl_opt_pass *
make_pass_cse3 (gcc::context *ctxt)
{
  return new pass_cse3 (ctxt);
}
